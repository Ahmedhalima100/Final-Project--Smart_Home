...
#ifndef UART_BLUETOOTH_INTERFACE_H_
#define UART_BLUETOOTH_INTERFACE_H_
...
* Output    : Error Status
* */
extern uint8_t HAL_BLUETOOTH_init(str_UartConfg_t * Uart_Config);
...
* Output    : Error Status
* */
extern uint8_t HAL_BLUETOOTH_sendByteBusyWait(const uint16_t u16_Data);
...
* Output    : Error Status
* */
extern uint8_t HAL_BLUETOOTH_recieveByteBusyWait(uint16_t *u16_Data);
...
* Output    : Error Status
* */
extern uint8_t HAL_BLUETOOTH_RecieveCallBack(void (*ptr_PointerToFunction)(uint16_t Copy_u16UartValue));
...
* Output    : Error Status
* */
extern uint8_t HAL_BLUETOOTH_SendCallBack(uint16_t *u16UartValue);

void UART_Transmit(uint8_t data);


#endif /* UART_BLUETOOTH_INTERFACE_H_ */
