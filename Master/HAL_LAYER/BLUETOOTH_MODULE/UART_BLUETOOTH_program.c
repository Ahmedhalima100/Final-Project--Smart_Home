...
#include "UART_BLUETOOTH_interface.h"
...
* Output    : Error Status
* */
uint8_t HAL_BLUETOOTH_init(str_UartConfg_t * Uart_Config)
{
...
* Output    : Error Status
* */
uint8_t HAL_BLUETOOTH_sendByteBusyWait(const uint16_t u16_Data)
{
...
* Output    : Error Status
* */
uint8_t HAL_BLUETOOTH_recieveByteBusyWait(uint16_t *u16_Data)
{
...
* Output    : Error Status
* */
uint8_t HAL_BLUETOOTH_RecieveCallBack(void (*ptr_PointerToFunction)(uint16_t Copy_u16UartValue))
{
	uint8_t Local_u8Error = NO_ERROR ;
...
* Output    : Error Status
* */
uint8_t HAL_BLUETOOTH_SendCallBack(uint16_t *u16UartValue)
{
	uint8_t Local_u8Error = NO_ERROR ;
